...
export let angryPigContent = {
    title: "Angry Angry Pig",
    link: `https://hazeelnut.itch.io/angry-angry-pig`,
    content: [
        {
            type: "paragraph",
        ...
        {
            type: "image",
            src: assetsMap.angryPig.image1,
            caption: "Splash screen"
        },
        {
            type: "image",
            src: assetsMap.angryPig.image2,
            caption: "Start of the game"
        },
        {
            type: "image",
            src: assetsMap.angryPig.image3,
            caption: "A really angry pig! >:)"
        },
        {
            type: "image",
            src: assetsMap.angryPig.image4,
